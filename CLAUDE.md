...
**Current week:** Week 4 — Connection manager UI + check editor UI (frontend). **Weeks 1–3 complete** (exit gates met); Week 4 in progress (~24/26 — only the admin page + check version-history drawer remain).

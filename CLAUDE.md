...
**Next milestone:** **Week 6 — Results dashboard + alerting** (early credit 2/27: Results page scaffold + severity badges, PR-C1). Scope locked by ADR [0022](docs/adr/0022-week6-prototype-adoption-and-chart-library.md): adopt the **full 13-screen prototype set** as dedicated, deep-linkable pages — **the Share drawer is the only surviving drawer; the prototype wins on any drawer-vs-page / layout conflict**. Screens: Dashboard landing (`/dashboard`, hosting the **recent-runs audit table** + health-score cards + 7-day quality-trend chart + per-suite pass/fail bars + per-check trend), run-detail route (`/results/:runId`), New-Suite + edit pages, New-Connection source-select split, **Profile content**, **Settings** (pulled in from Week 7), Admin layout-reconcile, and the 4xx/5xx error pages. **Chart library = recharts** (lazy-loaded; the chart-library decision is made). Plus the **alerting** track — `ResultPublisher` seam (ADR 0011) + Teams notification config / suppression / dedup / severity-aware routing. Live warehouse/file run remains the deferred Week-1 smoke.
**Active blockers:** none. Open follow-ups: profiler N+1 batching [#327](https://github.com/TheurgicDuke771/DataQ/issues/327) (backlog, split from #147), Week-4 frontend nits [#192](https://github.com/TheurgicDuke771/DataQ/issues/192)/[#197](https://github.com/TheurgicDuke771/DataQ/issues/197)/[#199](https://github.com/TheurgicDuke771/DataQ/issues/199)/[#204](https://github.com/TheurgicDuke771/DataQ/issues/204)/[#205](https://github.com/TheurgicDuke771/DataQ/issues/205), and backend [#194](https://github.com/TheurgicDuke771/DataQ/issues/194)/[#195](https://github.com/TheurgicDuke771/DataQ/issues/195). See [docs/progress.md](docs/progress.md).

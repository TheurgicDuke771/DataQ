...
/** #692 — SimpleList.Item rows must wrap on narrow containers: the actions region never shrinks. */
describe('SimpleList.Item', () => {
  ...
  it('wraps actions instead of squeezing the content (#692)', () => {
    ...
    // The content region (the row's first flex child) needs a real min-width floor — with bare
    // minWidth:0 it shrinks to a sliver before the actions ever wrap.

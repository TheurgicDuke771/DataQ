...
| AI integration | FastMCP — 46 curated MCP tools at `/mcp` (23 read-only, 18 that change state, 5 live-probe tools gated like writes) for Claude Desktop / Copilot / Cursor |

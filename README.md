...
| AI integration | FastMCP — 47 curated MCP tools at `/mcp` (24 read-only, 18 that change state, 5 live-probe tools gated like writes) for Claude Desktop / Copilot / Cursor |

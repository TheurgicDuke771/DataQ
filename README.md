...
| AI integration | FastMCP — 38 curated MCP tools at `/mcp` (18 read-only, 16 that change state, 4 live-probe tools gated like writes) for Claude Desktop / Copilot / Cursor |

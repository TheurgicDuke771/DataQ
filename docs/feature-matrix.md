...
| MCP | 19 curated tools at `/mcp` for AI assistants (ADR 0008; Tier 1 expansion #529). Served in every auth mode — SSO, email OTP, dev-bypass; under OTP the credential is a **PAT only** ([MCP setup](mcp-setup.md)) |

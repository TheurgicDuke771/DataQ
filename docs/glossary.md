...
| **MCP** | Model Context Protocol — DataQ exposes 30 curated tools at `/mcp` for AI assistants (16 read-only, 10 that change state, 4 live-probe tools gated like writes). |

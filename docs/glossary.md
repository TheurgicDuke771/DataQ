...
| **MCP** | Model Context Protocol — DataQ exposes 33 curated tools at `/mcp` for AI assistants (17 read-only, 12 that change state, 4 live-probe tools gated like writes). |

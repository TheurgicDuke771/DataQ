...
| **MCP** | Model Context Protocol — DataQ exposes 38 curated tools at `/mcp` for AI assistants (18 read-only, 16 that change state, 4 live-probe tools gated like writes). |

...
assets/lineage/incidents, alerting, scheduling, the 30-tool MCP server, PATs, rate limiting —
...
| MCP (30 tools) | E2E-verified | E2E-verified (PAT) | works; PAT-only under OTP (no IdP ⇒ no bearer) |

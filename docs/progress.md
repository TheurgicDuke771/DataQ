...
| **Open PRs** | **0** (2026-08-29 eve; #1656 merged, #1631 closed — W3's scheduled items are ALL done, only #1309 remains on the W3 board). ⚠️ Undeployed on main: the #1624 pushdown batch + the whole LLM track (#1636–#1656, migration `dd652ae1ef85`). |

...
| **Open issues** | **53** open repo-wide (2026-08-28) — W2 day 1 closed four of six: #1320 (#1604), #1326 (#1603), #1509 (#1608), #1505 (#1609). Filed from the same passes: #1602 (aggregate-stats monitor kind — the #1509 decision), #1605 (parity check beyond IS [NOT] NULL), #1607 (inert thresholds on the distinct-value set relations, W2), #1610 (export/import document-twin drift guard). Only #590/#588/#1392/#1257 remain of the W1 list — the two are the user's decision gates. |
| **Open PRs** | **0** (2026-08-28): #1603/#1604/#1608/#1609 merged same day. |
...
| Status | Task | Theme |
|---|---|---|
| ✅ | [#1509](https://github.com/TheurgicDuke771/DataQ/issues/1509) The 5 high-ROI GX built-ins (`mostly`, compound/cross-column, type, set/date) + the aggregate-stats kind decision — PR [#1608](https://github.com/TheurgicDuke771/DataQ/pull/1608): 7 new catalog types + `mostly` (floored 0.01 — `mostly=0` is a silent green), aggregates decided onto the monitor-kind path ([#1602](https://github.com/TheurgicDuke771/DataQ/issues/1602)); strftime is dataframe-only (gated on all three doors), set relations have inert thresholds ([#1607](https://github.com/TheurgicDuke771/DataQ/issues/1607)); cross-column types sqlite-proven, **not yet live-verified on Snowflake/Databricks SQL** (#953 rule — before next deploy) | intelligence |
| 🟡 | [#1510](https://github.com/TheurgicDuke771/DataQ/issues/1510) Curated expectation superset (4a) + **server-side `expectation_type` allowlist** on REST + MCP — in progress | intelligence / security |

...
| **Open issues** | **64** (W1 progress 2026-07-04: #194/#195/#587/#588 closed via #602/#603/#607/#608; [#604](https://github.com/TheurgicDuke771/DataQ/issues/604) — CI-flaky ConnectionNew test — filed and closed same-day by #603; filed still-open: [#601](https://github.com/TheurgicDuke771/DataQ/issues/601) prettierignore gap + [#605](https://github.com/TheurgicDuke771/DataQ/issues/605) surface run failure reasons, both `v1.1 Backlog`). At the 2026-07-04 full backlog remap: **55 scheduled** onto `v1.1 Week 1..6` + **10** on `v1.1 Week 7 — stretch` + the cycle epic [#597](https://github.com/TheurgicDuke771/DataQ/issues/597). **`v1.1 Backlog` (renamed from `Backlog (post-v1 / testing)`) holds only the new filings #601/#605** — every other open issue sits on a week milestone; the backlog milestone is the default for new filings. Every scheduled issue carries an **Acceptance criteria** checklist and every milestone description its **Exit gate** (both added 2026-07-04). Theme map in [post-v1-roadmap.md](../context/post-v1-roadmap.md). |
| **Open PRs** | none |
...
### v1.1 W1 — Snowflake close-out + PATs (due 2026-07-11) — 4/6
...
| ✅ | [#588](https://github.com/TheurgicDuke771/DataQ/issues/588) Retire the harness Snowflake leg — **done 2026-07-04** (ops, no code): 4 schedules disabled + 4 bindings deleted, 3 connections renamed RETIRED, 4 KV secrets deleted out-of-band (`az` — SecretStore.delete is #372, W2), Snowflake PAT revoked + PERF schema dropped; history verified queryable (1,940 results, all with `metric_value`) — [PR #608](https://github.com/TheurgicDuke771/DataQ/pull/608) (docs note) | ops / G-i |

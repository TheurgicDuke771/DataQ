...
| **Open PRs** | **0** (2026-08-29 eve). **W3 milestone CLOSED at 19/19** — all six scheduled items plus the in-week #1634/#1631; #1309 closed via #1638's review fixups. ⚠️ Undeployed on main: the #1624 pushdown batch + the whole LLM track (#1636–#1657, migration `dd652ae1ef85`). |

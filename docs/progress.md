...
| **Open issues** | **58** open repo-wide (2026-08-25, post the W1 MCP honesty burn-down: #1442/#1445/#1446/#1448 closed via #1590/#1591/#1593, #1592 filed). At planning (2026-08-21): **55** — the 52 re-homed from the closed `v1.1 Backlog` milestone into `v1.2 Week 1..8`, epic #1518 (W8), plus the two never-backlogged AWS-security items caught in the final sweep — [#1385](https://github.com/TheurgicDuke771/DataQ/issues/1385) (ElastiCache at-rest + egress restriction → W7) and [#1384](https://github.com/TheurgicDuke771/DataQ/issues/1384) (CloudFront→ALB TLS hop — blocked on buying a custom domain + ACM, → `v1.2 Backlog`). `v1.2 Backlog` otherwise **empty** as the default for new filings. |
| **Open PRs** | **1** (2026-08-25): #1593 (#1448, in CI) + #1443's rename PR to follow. #1585/#1586 merged 2026-08-24. |

...
| **Open PRs** | **1** (2026-08-29): [#1629](https://github.com/TheurgicDuke771/DataQ/pull/1629) — #1624 UC pushdown batch, shipped early out of its W6 slot, `/code-review` findings fixed, live-Databricks-verified, awaiting merge. |

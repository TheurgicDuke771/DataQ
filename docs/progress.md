...
| **Open issues** | **53** open repo-wide (2026-08-29) — **W2 closed all six scheduled items in one day**: #1320 (#1604), #1326 (#1603), #1509 (#1608), #1505 (#1609), #1551 (#1611), #1510 (#1614). Then the user-directed follow-through closed #1607 (#1619) and the live-verification-found #1616 (#1617) same day. Backlog filings from the passes: #1602 (aggregate-stats monitor kind), #1605, #1610, #1613, #1618 (compound expected_value casing). ✅ The #953 pre-deploy requirement is **discharged**: every #1608/#1614 SQL-capable type live-verified on Snowflake (evidence on both PRs); the one live-only failure (compound-unique uppercase KeyError) fixed in #1617. ⚠️ Next deploy carries migration `5656bbfc1495` (nulls always-inert thresholds on the set relations). Only #590/#588/#1392/#1257 remain of the W1 list — the two are the user's decision gates. |
...
| **Open PRs** | **0** (2026-08-29): [#1629](https://github.com/TheurgicDuke771/DataQ/pull/1629) — #1624 UC pushdown batch, shipped early out of its W6 slot — merged (`/code-review` found a real index-column clash gap for the new column_A/column_B/column_list-keyed types, fixed + mutation-verified; live-Databricks-verified all 14 types). ⚠️ Not deployed yet — no migration in the delta, but the pushdown routing change is live-behavior-affecting for UC suites on next deploy. |

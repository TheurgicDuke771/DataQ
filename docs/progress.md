...
| **Roadmap tasks done** | 60 ✅ + 9 🟡 / 161 (~37%) |
...
### GX-Cloud-style UI redesign (added — not in original roadmap) (4 tasks — 2/4 ✅)
...
**Week 4 total: 14 / 26 ✅ (+2 🟡, 1 🔵)** _(connection manager UI complete (6/6); check editor core shipped; GX-Cloud redesign — connections add page + edit-only drawer shipped (PR-A1/A2); checks redesign next (PR-B1/B2); PR-3c polish 2/3 (Settings `forbid` 🔵 blocked on the `.env` split) — dry-run + profiler panel + sharing/admin UI remain)_

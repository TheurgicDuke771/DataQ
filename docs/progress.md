...
| **Open PRs** | **0** (2026-08-29 pm). ⚠️ Undeployed on main: the #1624 pushdown batch + the whole LLM track (#1636–#1643 — migration `dd652ae1ef85` in the next deploy's delta; frontend gains the admin LLM panel). |

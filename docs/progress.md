...
| **Open issues** | **52** open repo-wide (2026-08-28) — **W2 closed all six scheduled items in one day**: #1320 (#1604), #1326 (#1603), #1509 (#1608), #1505 (#1609), #1551 (#1611), #1510 (#1614). Filed from the same passes: #1602 (aggregate-stats monitor kind — the #1509 decision), #1605 (parity beyond IS [NOT] NULL), #1607 (inert thresholds on set relations, W2), #1610 (document-twin drift guard), #1613 (historical engine/dimension on ResultRead). ⚠️ Pre-deploy requirement: live-verify #1608/#1614's SQL-capable types on Snowflake/Databricks (#953). Only #590/#588/#1392/#1257 remain of the W1 list — the two are the user's decision gates. |
| **Open PRs** | **0** (2026-08-28): #1603/#1604/#1608/#1609/#1611/#1614 merged same day. |
